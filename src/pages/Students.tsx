...
export default function Students() {
  ...
  // Unique majors and grad years for filter dropdowns
  ...
  const processedStudents = students
    ...
    .sort((a: any, b: any) => {
      ...
      if (sortField === "name") {
        ...
        aVal = String(a.id);
        bVal = String(b.id);
      } else if (sortField === "grad_year") {
        aVal = String(a.grad_year || "");
        bVal = String(b.grad_year || "");
              ...
              <div className="flex items-center gap-2 relative" ref={filterRef}>
                ...
                {showFilterPanel && (
                  <div className="absolute top-10 right-0 z-50 bg-popover border border-border rounded-xl shadow-xl p-4 w-64 space-y-4">
                    ...
                    <Button size="sm" className="w-full" onClick={() => setShowFilterPanel(false)}>
                      Apply
                    </Button>
                  </div>
                )}
